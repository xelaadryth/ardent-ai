...
## Around City
- **Bendfields**: Grazing for ranched animals hunting retracting tall grass to the north, largely untended.
- **Shellfarms**: Covered areas to the west of the city, better stormbreak, ranching.
- **Cremfall Rise**: Heavy deposits of crem to the east that grow and shrink with the storms, rock formations.
- **[[Darkstone Forest]]**: Darkwood trees encased in crem to the east of Cremfall Rise towards the river.
...
- **Guilds District**: North.
  - Ironward Consortium, Shardseekers, Luminous Vault, Spherescale Hall, Dustroad Braves, Spineslayers, Concord of Steel, Dueling Heralds, [[The Vamah Archivum]] (largest library, near the Gemheart Inn).
